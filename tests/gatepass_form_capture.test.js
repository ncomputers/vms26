...
test('photo capture enables next button and stores image', async () => {
    ...
    <div id="visitor_photoControls" data-prefix="visitor">
      ...
      <div id="visitor_photoBox">
        ...
        <div class="photo-actions">
          <button id="visitor_capture"></button>
          <button id="visitor_uploadBtn"></button>
        </div>
      </div>
  ...
  const script = `
    const captureBtn = document.getElementById('visitor_capture');
    const uploadBtn = document.getElementById('visitor_uploadBtn');
