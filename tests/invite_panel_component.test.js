...
test('validates fields before creating invite', async () => {
  document.body.innerHTML = `
    <form id="manualForm">
      ...
      <div class="photo-controls" data-prefix="p"><input type="hidden" /></div>
...
test('submits form data to /invites', async () => {
  document.body.innerHTML = `
    <form id="manualForm">
      ...
      <select id="linkHost"></select>
      <select id="linkType"></select>
      <div class="photo-controls" data-prefix="p"><input type="hidden" value="" /></div>
      <video id="p_preview"></video>
      <img id="p_photoPreview" />
      <button id="p_capture"></button>
      <div id="p_cameraError"></div>
