...
GATEPASS_RETENTION_SECS = 7 * 24 * 60 * 60  # default to 7 days
...
)  # will be imported lazily in init_context
redisfx = None
    ...
    try:
        ...
        if phone:
            ...
            try:
                ...
                redis.set(key, value, ex=GATEPASS_RETENTION_SECS)
            except Exception:
...
def init_context(
    ...
    global redis, templates, visitor, redisfx
    ...
    try:
        ...
        global GATEPASS_RETENTION_SECS
        GATEPASS_RETENTION_SECS = getattr(
            visitor, "VISITOR_LOG_RETENTION_SECS", GATEPASS_RETENTION_SECS
        )
