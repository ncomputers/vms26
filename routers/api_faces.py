...
async def api_search_face(
    ...
    Returns a list of matches with similarity scores or an error response on
    failure. This fixes a previous bug where results were never returned.
    """
    ...
    try:
        ...
        return error_response(
            "processing_failed", "Face search failed", status_code=500
        )
